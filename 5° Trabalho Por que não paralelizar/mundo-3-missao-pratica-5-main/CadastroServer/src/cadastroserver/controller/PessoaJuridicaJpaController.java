    ...
    public void create(PessoaJuridica pessoaJuridica) throws IllegalOrphanException, PreexistingEntityException, Exception {
        ...
        if (pessoaOrphanCheck != null) {
            ...
            if (oldPessoaJuridicaOfPessoa != null) {
                ...
                illegalOrphanMessages.add("The pessoa " + pessoaOrphanCheck + " already has an item of type PessoaJuridica whose pessoa column cannot be null.");
            }
        }
        if (illegalOrphanMessages != null) {
        ...
        try {
            ...
            if (pessoaNew != null && !pessoaNew.equals(pessoaOld)) {
                ...
                if (oldPessoaJuridicaOfPessoa != null) {
                    ...
                    illegalOrphanMessages.add("The pessoa " + pessoaNew + " already has an item of type PessoaJuridica whose pessoa column cannot be null.");
                }
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
